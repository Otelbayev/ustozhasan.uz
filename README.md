...
- `dist/lead.js` — tasdiqlangan JSON javobi, timeout va qayta yuborish ID himoyasi
...
## Tekshiruv
- `node --test tests/phone.test.mjs tests/apps-script.test.mjs tests/lead.test.mjs`
